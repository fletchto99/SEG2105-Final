...
Keeper.createModule(function (Keeper) {
    ...
    Module.display = function (ContentPane, parameters) {
        ...
        if (Keeper.hasRole('Player')) {
            ...
            createElement({
                elem: 'p',
                textContent: 'Once you have created a player account, you can now join a team. Click on the link "Teams" in the navigation bar to display the team list.Click on the "Join Team" button beside your chosen team to join it. You can also click on "Statistics" button of a given team to view the players in the team, their goals scored, and their team ranking (based on total goals scored).',
                putIn: ContentPane
            });
        ...
        if (Keeper.hasRole('Organizer')) {
            ...
            createElement({
                elem: 'p',
                textContent: 'As an organizer, you have the ability to create new players. Simply navigate to "Teams" from the navigation bar, and press "Create player".Enter the name and jersey number of the player, and press "Create".',
                putIn: ContentPane
            });
            ...
            createElement({
                elem: 'p',
                textContent: 'Click on the link "Teams" in the navigation bar to display the team list.Click on the "Join Team" button beside your chosen team to join it.You can also click on "Statistics" button of a given team to view the players in the team, their goals scored, and their team ranking (based on total goals scored). You can also add a player to a team by chosing "Add a player" button of the chosen team, and then chosing the player to add from the drop down list.',
                putIn: ContentPane
            });
            ...
            createElement({
                elem: 'p',
                textContent: 'As an organizer, you have the ability to create new teams. In order to create a team, there must exist atleast one free player (a player unattached to a team).This is beacause every team needs a unique team captain. ',
                putIn: ContentPane
            });
            ...
            createElement({
                elem: 'p',
                textContent: 'To view all tournaments (Pre-game, In-progress, or Post-game), click on the "Tournament" button in the navigation bar. You can view the teams entered in each tournament by pressing the "Teams" button beside a specific team. For Post-game tournaments, you can also view the completed matches with results, and final team standings.',
                putIn: ContentPane
            });
            createElement({
                elem: 'h3',
